...
RUN apt-get update && apt-get -y install git curl apache2 php5 php5-mysql php5-mcrypt php5-json php5-imap libapache2-mod-php5 php5-curl php5-gd && apt-get clean && rm -rf /var/lib/apt/lists/*
